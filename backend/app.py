...
#         proxima_linha = len(sheet_vendas.get_all_values()) + 1

#         # Escreve apenas nas colunas sem fórmula
#         sheet_vendas.batch_update([
#             {'range': f'C{proxima_linha}', 'values': [[dados['produto']]]},
#             {'range': f'D{proxima_linha}', 'values': [[quantidade]]},
#             {'range': f'F{proxima_linha}', 'values': [[preco_unitario]]},
#             {'range': f'H{proxima_linha}', 'values': [[dados['data_venda']]]},
#             {'range': f'I{proxima_linha}', 'values': [[dados['cliente']]]},
#             {'range': f'J{proxima_linha}', 'values': [[dados['status_pagamento']]]},
#             {'range': f'K{proxima_linha}', 'values': [[dados['condicao']]]}
#         ])
